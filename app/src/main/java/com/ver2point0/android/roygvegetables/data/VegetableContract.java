...
public class VegetableContract {
    ...
    public static class VegetableEntry implements BaseColumns {
        ...
        public static final String COLUMN_VEGETABLE_NAME = "name";
        public static final String COLUMN_VEGETABLE_PHOTO = "photo";
        public static final String COLUMN_VEGETABLE_PRICE = "price";
        public static final String COLUMN_VEGETABLE_QUANTITY = "quantity";
        public static final String COLUMN_VEGETABLE_SUPPLIER = "supplier";
